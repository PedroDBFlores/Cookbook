...
interface RecipeDetailsActionsProps {
	recipe: RecipeDetail
	deleteRecipeFn: (id: number) => Promise<void>
}

const RecipeDetailsActions: React.FC<RecipeDetailsActionsProps> = ({ recipe, deleteRecipeFn }) => {
	const { t } = useTranslation()
	...
	const onEdit = (id: number) => navigate(`/recipe/${id}/edit`)
